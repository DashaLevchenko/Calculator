...
// s-square;
    ...
    void checkInput() {
        ...
        assertNumber("0", "b", "d");
        assertNumber("0", "1b", "c");
        assertNumber("0", "01b", "d");
        assertNumber("1", "001", "c");
        assertNumber("5", "000005", "c");
        assertNumber("1 111", "11111b", "d");
        assertNumber("-1 111", "11111nb", "d");
        assertNumber("0", "11111nbbbbb", "d");
        assertNumber("-6", "0000006n", "c");
        assertNumber("7", "00000007", "d");
        assertNumber("11 111", "111111nbn", "d");
        assertNumber("11 111 111", "11111111,b", "c");
        assertNumber("9", "0000000009", "d");
        assertNumber("0", "11111nbbbbb", "c");
        assertNumber("11", "000000000011", "d");
        assertNumber("-111 111 111", "111111111,bn", "c");
        assertNumber("-1 111 111 111,", "1111111111,bn,", "c");
        assertNumber("123", "000000000000123", "d");
        assertNumber("12 345", "0000000000000012345", "d");
        assertNumber("1 111 111 111 111 111", "1111111111111111,b", "c");
        assertNumber("12 345 678", "000000000000000012345678", "c");
        assertNumber("1 111 111 111 111 111", "1111111111111111,111111b", "d");
        ...
        assertNumber("-222,3333333333333", "222,3333333333333n", "c");
        assertNumber("222,3333333333333", "222,3333333333333nn", "d");
        assertNumber("-222,3333333333333", "222,3333333333333n33", "c");
        assertNumber("222,3333333333333", "222,3333333333333nn33,", "d");
        ...
        assertNumber("-9 999 999 999 999 999,", "9999999999999999,9999n", "d");
        assertNumber("9 999 999 999 999 999,", "9999999999999999,9999nn", "c");
        assertNumber("9 999 999 999,999999", "9999999999,999999,9999", "d");
        assertNumber("-9 999 999 999,999999", "9999999999,999999,9999n", "d");
        assertNumber("-9 999 999 999,999999", "9999999999,999999,9999nnnnn99", "c");
        assertNumber("-1", "1111111111111111,111111nbbbbbbbbbbbbbbbb", "d");
        assertNumber("1,111111111111111", "1111111111111111,111111nbbbbbbbbbbbbbbbbn,1111111111111111", "c");
    }
