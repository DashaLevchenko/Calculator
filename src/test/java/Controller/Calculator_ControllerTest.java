...
//Four operands
    ...
    void checkOperationMemory() {
        ...
        assertNumber("9,999999999999998e+31", "9999999999999999 * = + 31 + 552 + 55 -", "9,999999999999998e+31 + 31 + 552 + 55 - ");
    }
        @Test
...
//            assertNumber("-1,502711155880507e-16", "6654638824545454 sqrt +/- 1/x +/- sqr +/- ", "negate(sqr(negate(1/(negate(√(6654638824545454))))))");
        ...
        void checkOperationsEnotationValid () {
            ...
            assertNumber("1,e-17", "0,0000000000000001 / 9,999999999999996 =", "");
            assertNumber("1,1e-16", "0,0000000000000011 / 9,999999999999996 =", "");
            assertNumber("1,e-18", "0,0000000000000001 / 99,99999999999996 =", "");
            assertNumber("1,e-30", "0,000000000000001 / 999999999999999,9 =", "");
            assertNumber("1,e-31", "0,0000000000000001 / 999999999999999,6 =", "");
            assertNumber("1,111111111111111e-16", "0,1111111111111111 / 999999999999999,6 =", "");
            assertNumber("1,1111111111111e-4", "0,0011111111111111 / 9,999999999999996 =", "");
            assertNumber("1,1111111111111e-5", "0,0011111111111111 / 99,99999999999996 =", "");
            assertNumber("1,e+16", "9999999999999999 + 0,9999999999999996 = ", "");
